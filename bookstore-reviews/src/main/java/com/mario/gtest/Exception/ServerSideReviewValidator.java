...
@ControllerAdvice
public class ServerSideReviewValidator extends ResponseEntityExceptionHandler 
{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException exp,
		...
		errorList.stream().forEach((e)->{
			String propertyTitle = ((FieldError)e).getField();
			String errorMsg = e.getDefaultMessage();
			
			errorMap.put(propertyTitle, errorMsg);
		});
